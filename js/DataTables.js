...
(function (h) {
  ...
  function ja(a, b, c) {
    ...
    c !== k && null !== c && (fb(c), K(m.defaults.column, c), c.mDataProp !== k && !c.mData && (c.mData = c.mDataProp), c.sType && (b._sManualType = c.sType), c.className && !c.sClass && (c.sClass = c.className), h.extend(b, c), E(b, c, 'sWidth', 'sWidthOrig'), c.iDataSort !== k && (b.aDataSort = [
      c.iDataSort
    ]), E(b, c, 'aDataSort'));
    var g = b.mData,
    j = Q(g),
  ...
  function Ga(a) {
    ...
    t;
    e = 0;
    for (f = b.length; e < f; e++) if (l = b[e], t = [
  ...
  function pb(a) {
    ...
    i = h('input', b).val(e.sSearch).attr('placeholder', d.sSearchPlaceholder).bind('keyup.DT search.DT input.DT paste.DT cut.DT change.DT', g ? Oa(f, g)  : f).bind('keypress.DT', function (a) {
  ...
  function Va(a, b, c, d) {
    ...
    c && a.oFeatures.bSortMulti ? (c = h.inArray(b, G(e, '0')), - 1 !== c ? (b = g(e[c], !0), null === b && 1 === e.length && (b = 0), null === b ? e.splice(c, 1)  : (e[c][1] = f[b], e[c]._idx = b))  : (e.push([b,
    f[0],
  ...
  function Lb(a, b, c) {
    ...
    }), h.extend(!0, a[e], d))  : a[e] = c && 'data' !== e && 'aaData' !==
  ...
  s('rows().ids()', 'row().id()', function (a) {
    for (var b = [
    ], c = this.context, d = 0, e = c.length; d < e; d++) for (var f = 0, g = this[d].length; f < g; f++) {
  ...
  'cell'], function (a, b) {
    ...
    oLanguage: {
      ...
      sEmptyTable: '无结果',
      sInfo: '显示 _START_ 到 _END_ 共 _TOTAL_ 条结果',
      sInfoEmpty: '显示 0 到 0 共 0 条结果',
      sInfoFiltered: '(从 _MAX_ 条目中过滤)',
      sInfoPostFix: '',
      sDecimal: '',
      sThousands: ',',
    ...
    sJUIHeader: '',
    sJUIFooter: ''
  }); var Ca = '', Ca = '', H = Ca + 'ui-state-default', ia = Ca + 'css_right ui-icon ui-icon-', Xb = Ca + 'fg-toolbar ui-toolbar ui-widget-header ui-helper-clearfix'; h.extend(m.ext.oJUIClasses, m.ext.classes, {
